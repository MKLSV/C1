...
insert into questions (stage, text, intent, source, priority) values
    ('rapport',       'Что тебя привело? Что сейчас не так с работой или выбором?', 'context', 'MI', 5),
    ('interests',     'Расскажи про занятие, за которым ты теряешь счёт времени. Что именно ты там делаешь?', 'riasec', 'RIASEC', 5),
    ('interests',     'Кем ты восхищался(ась) в детстве и за что именно?', 'identity', 'CCI', 4),
    ('interests',     'За каким контентом ты залипаешь — каналы, блоги, видео? О чём они?', 'riasec', 'CCI', 4),
    ('skills',        'Назови 2-3 вещи, за которые тебе уже платили или просили совета в последний год.', 'skills_paid', 'Transferable', 5),
    ('skills',        'Что даётся тебе заметно легче, чем большинству вокруг?', 'skills', 'Transferable', 4),
    ('values',        'Сколько денег в месяц для тебя "спокойно"? А "отлично"?', 'income', 'Ikigai', 5),
    ('values',        'Что тебе ближе: делать руками, головой, с людьми или в одиночку? Наём, фриланс или своё дело?', 'format', 'Ikigai', 5),
    ('reality_check', 'По "[навык] + услуги" заказов сейчас много. Хочешь посмотреть, как на этом зарабатывают?', 'demand', 'Solopreneur', 3),
    ('business',      'Кто твои первые 5-10 клиентов и что у них болит?', 'business_idea', 'Solopreneur', 4),
